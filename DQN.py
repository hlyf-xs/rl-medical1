...
if __name__ == '__main__':
    ...
    # args: Namespace(algo='DQN', files=None, gpu=None, load=None, logDir='train_log',
    # name='experiment_1', saveGif=False, saveVideo=False, task='train')
    ...
    args.algo = 'DQN'
    args.gpu = 0
    args.files = ['./data/filenames/image_files.txt', './data/filenames/landmark_files.txt']

    # Evaluate
    # args.task = 'eval'
    # args.algo = 'DQN'
    # args.gpu = 0
    # # args.load = './data/models/DQN_multiscale_brain_mri_point_pc_ROI_45_45_45/model-600000'
    # args.load = './data/models/DQN_multiscale_brain_mri_point_pc_ROI_45_45_45/model-725000'
    # args.files = ['./data/filenames/image_files.txt', './data/filenames/landmark_files.txt']
    ...
    # args.gpu = 0
    # args.load = './data/models/DQN_multiscale_brain_mri_point_pc_ROI_45_45_45/model-725000'
    # args.files = ['./data/filenames/image_files.txt']
